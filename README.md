...
This project explores [Elegant Objects](https://www.elegantobjects.org/) principles by Yegor Bugayenko (or not?):
...
This project is a **work in progress** focused on exploring OOP principles. Feature completeness is secondary to design quality.

- **Bug fixes**: Addressed as found
- **New features**: Added as the prototype evolves
